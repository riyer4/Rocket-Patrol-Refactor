class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.miniShip01 = new miniSpaceship(this, game.config.width*2, borderUISize*8, 'miniSpaceship', 0, 50).setOrigin(0, 0)
        this.miniShip02 = new miniSpaceship(this, game.config.width + borderUISize*8, borderUISize*8 + borderPadding*2 , 'miniSpaceship', 0, 50).setOrigin(0, 0)
        this.miniShip03 = new miniSpaceship(this, game.config.width, borderUISize*8 + borderPadding*8, 'miniSpaceship', 0, 50).setOrigin(0, 0)
